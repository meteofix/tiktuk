    ...
    return (
        <div className={isMobile? classes.userMain + ' ' + classes.userMainMobile : classes.userMain}>
            <div className={isMobile? classes.videoFeedTab + ' ' + classes.videoFeedTabMobile : classes.videoFeedTab}>
                ...
                {isDesktopOrTablet &&
                <div style={hoverTab?{transform: 'translateX(0px)'}:{transform: 'translateX(297px)'}}
                     className={isMobile? classes.bottomLine + ' ' + classes.bottomLineMobile : classes.bottomLine}></div>
                }
