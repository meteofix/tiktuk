...
const UserTitleContainer = ({uniqueId, verified, nickname}) => {
    ...
    return (
        <div className={isMobile? classes.userTitleContainer + ' ' + classes.userTitleContainerMobile : classes.userTitleContainer}>
            <h2 className={isMobile? classes.userTitle + ' ' + classes.userTitleMobile : classes.userTitle}>
                {isMobile && '@'}
                {uniqueId}
                {verified ? <UserVerifiedIcon small cl={isMobile? classes.verified + ' ' + classes.verifiedMobile : classes.verified}/> : ''}
            </h2>
            {isDesktopOrTablet &&
